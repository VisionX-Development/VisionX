...
import { MainText, TermsMain } from "../styles/PrivacyTerms";
  ...
  return (
    <TermsMain>
      ...
      <MainText className="impressumMain regText">
        <h2>Einleitung</h2>
        <p>
          Mit der folgenden Information sollen Sie, ggf. als "betroffene
          Person", einen Überblick über die Verarbeitung Ihrer personenbezogenen
          Daten sowie Ihre Rechte aus dem Datenschutzgesetzen erhalten. Ein
          Besuch dieser Internetseiten ist grundsätzlich ohne Eingabe
          personenbezogener Daten möglich. Sofern Sie besondere Funktionen z.B.
          im Rahmen von Web-Applikationen wie z.B. {""}
          <strong>"STAR.VISIONX.DEV"</strong> in Anspruch nehmen möchten, ist
          eine Verarbeitung personenbezogener Daten u.a. zur Registrierung und
        ...
        <p>
          ...
          lückenlosen Schutz der verarbeiteten personenbezogenen Daten
          sicherzustellen. Dennoch können bei einer internetbasierten
          Datenübertragungen sowie Datenverwaltung grundsätzlich (unbekannte)
          Sicherheitslücken auftreten oder entstehen, sodass ein absoluter
          Schutz nicht gewährleistet werden kann. Die Angabe Ihrer
          personenbezogenen Daten ist freiwillig und aus der nicht-Angabe
        ...
        <p>
          ...
          Datenschutzerklärung soll sowohl für Sie einfach lesbar und
          verständlich sein. Um dies zu gewährleisten, möchten ich vorab die
        ...
        <p>
          ...
          erforderlich sind, etwa in Fällen von Anfragen zur bestimmten
        ...
        <p>
          ...
          basiert die Verarbeitung auf Art. 6 Abs. 1 lit. c DS-GVO.
        </p>
        <p>
        ...
        <p>
          ...
          eines berechtigten Interesses von VISIONX.DEV oder eines Dritten
          ...
          besteht, z. B. wenn die betroffene Person ein Kunde (ggf. Nutzer von
          Services) des Verantwortlichen ist oder in seinen Diensten steht
        ...
        <p>
          ...
          ein "http<strong>s</strong>://" steht und an dem Schloss-Symbol in
          Ihrer Browserzeile. Wenn die SSL- bzw. TLS-Verschlüsselung aktiviert
          ist, können die Daten, die Sie an VISIONX.DEV übermitteln, nicht von
        ...
        <p>
          Bei der lediglich informatorischen Nutzung der Websiten von
          VISIONX.DEV, also wenn Sie sich nicht registrieren oder anderweitig
          Informationen übermitteln, werden nur solche Daten erhoben, die Ihr
          Browser an den Server übermittelt (in sog. "Server-Logfiles").
          VISIONX.DEV Internetseiten erfasst mit jedem Aufruf einer Seite durch
          Sie oder ein automatisiertes System eine Reihe von allgemeinen Daten
        ...
        <p>
          - die Inhalte/ Funktionen und Services der Internetseiten zu
          optimieren,
        </p>
        <p>
          - die dauerhafte Funktionsfähigkeit der IT-Systeme und der Techniken
          der Internetseiten zu gewährleisten sowie
        </p>
        <p>
        ...
        <p>
          ...
          die Datensicherheit zu erhöhen, um letztlich ein optimales
          Schutzniveau für die verarbeiteten personenbezogenen Daten
          sicherzustellen. Die Daten der Server-Logfiles werden getrennt von
          allen durch eine betroffene Person angegebenen personenbezogenen Daten
          gespeichert.
        </p>
        <p>
          Die Rechtsgrundlage für diese Art der Datenverarbeitung ist Art. 6
          Abs. 1 S. 1 lit. f DS-GVO. Das berechtigtes Interesse folgt aus oben
        ...
        <p>
          VISIONX.DEV gibt Ihre persönlichen Daten nur an Dritte weiter, wenn
        </p>
        <p>
        ...
        <p>
          ...
          berechtigter Interessen zulässig ist und kein Grund zur Annahme
        ...
        <p>
          - dies gesetzlich zulässig und nach Art. 6 Abs. 1 S. 1 lit. b DS-GVO
          für die Abwicklung von Vertrags- oder Nutzerverhältnissen mit Ihnen
          erforderlich ist.
        </p>
        <h2>Cookies</h2>
        ...
        <p>
          ...
          auf Ihrem IT-System (Laptop, Tablet, Smartphone o.ä.) gespeichert
          werden, wenn Sie Seite von VISIONX.DEV oder angeschlossene Seiten
        ...
        <p>
          ...
          bedeutet nicht, dass VISIONX.DEV dadurch unmittelbar Kenntnis von
          Ihrer Identität erhält.
        </p>
        <p>
          Der Einsatz von Cookies dient einerseits dazu, die Nutzung des
          Angebots der Webseiten/ Web-Applikationen von VISIONX.DEV für Sie
          angenehmer zu gestalten. So werden sogenannte Session-Cookies
          eingesetzt, um zu erkennen, dass Sie einzelne Seiten der Websiten
          bereits besucht haben oder sich erfolgreich ein- oder ausgeloggt
          haben. Diese können auch nach verlassen der Webseiten noch eine
          verstgelegte Zeit in Ihrem Browser gespeichert bleiben um Sie bei
          einem späteren Besuch schneller wieder zu erkennen.
        </p>
        <p>
          Die durch Cookies verarbeiteten Daten sind für die genannten Zwecke
          zur Wahrung der berechtigten Interessen von VISIONX.DEV sowie der
          Dritter nach Art. 6 Abs. 1 S. 1 lit. f DS-GVO erforderlich.
        </p>
        <p>
        ...
        <p>
          ...
          registrieren. Manchmal erfolgt die Registrierung ausschließlich über
          den Administrator.
        </p>
        <p>
          Welche personenbezogenen Daten dabei an VISIONX.DEV übermittelt
          werden, ergibt sich aus der jeweiligen Eingabemaske, die für die
          Registrierung verwendet wird. Erfolgt die Registrierung über einen
          Administrator fordert er die entsprechenden Daten aktiv von Ihnen ein.
          Dabei wird noch unterschieden zwischen Daten welche so wie sie
          eingegeben werden in die Datenbank gespeichert werden (z.B. Name,
          E-Mail) sowie Daten welche selbst für VISIONX.DEV oder allen
          Administratoren nicht einsehbar und nach einem Verschlüsselungsprinzip
          in die Datenbank abgespeichert werden (z.B. Ihr Passwort). Die von
          Ihnen eingegebenen personenbezogenen Daten werden ausschließlich für
          die interne Verwendung und für funktionelle Zwecke in Bezug auf den
          jeweiligen Service erhoben und gespeichert.
        </p>
        <p>
          ...
          der Internetseiten von VISIONX.DEV erforderlich. Eine Weitergabe
        ...
        <p>
          ...
          abzuändern oder vollständig aus dem Datenbestand löschen zu lassen,
          mit den hiermit entsprechend verbundenen Einschränkungen der Nutzung.
        </p>
        <p>
          VISIONX.DEV erteilt Ihnen jederzeit auf Anfrage Auskunft darüber,
          welche personenbezogenen Daten über Sie gespeichert sind. Ferner
          berichtigt oder löscht VISIONX.DEV personenbezogene Daten auf Ihren
          Wunsch, soweit dem keine gesetzlichen Aufbewahrungspflichten
          entgegenstehen. Verantwortlich für den Datenschutz, steht Ihnen
          VISIONX.DEV und in diesem Namen der Inhaber der Domain, als betroffene
          Person jederzeit als Ansprechpartner zur Verfügung.
        </p>
        <p>
          Die Verarbeitung Ihrer Daten erfolgt im Interesse einer komfortablen
          und einfachen Nutzung der Internetseiten und Web-Applikationen von
          VISIONX.DEV. Dies stellt ein berechtigtes Interesse im Sinne von Art.
        ...
        <p>
          Gemäß Art. 6 Abs. 1 lit. b DS-GVO werden personenbezogene Daten
          erhoben und verarbeitet, wenn Sie diese zur Durchführung eines
          ...
          ersichtlich. Bei Eröffnung eines Kontos über einen Administrator fragt
          er Sie direkt nach den entsprechenden Daten. Die Kommunikation über
          einen Administrator erfolgt ausschließlich über die E-Mail-Adressen
          der Domain, z.B.{""} <strong>info(@v)isionx.dev</strong>. Eine
          Löschung Ihres Kundenkontos ist jederzeit möglich und kann durch eine
          Nachricht an die o.g. E-Mail-Adresse an den Verantwortlichen erfolgen.
        </p>
        <p className="bold">Kontaktaufnahme / Kontaktformular</p>
        <p>
          Im Rahmen der Kontaktaufnahme mit VISIONX.DEV (z.B. per
          Kontaktformular oder E-Mail) werden personenbezogene Daten erhoben.
          Welche Daten im Falle eines Kontaktformulars erhoben werden, ist aus
          dem jeweiligen Kontaktformular ersichtlich. Auch Administratoren von
          VISIONX.DEV können bestimmte Daten erheben, dies geschieht
          ausschließlich per E-Mail über unserer Domain, z.B.{" "}
          <strong>info(@)visionx.dev</strong>. Diese Daten werden ausschließlich
          zum Zweck der Beantwortung Ihres Anliegens bzw. für die
          ...
          Daten das berechtigte Interesse von VISIONX.DEV an der Beantwortung
          Ihres Anliegens gemäß Art. 6 Abs. 1 lit. f DS-GVO. Zielt Ihre
          Kontaktierung auf den Abschluss eines Vertrages oder einer
        ...
        <p>
          VISIONX.DEV nutzt Google Analytics, ein Webanalysedienst der Google
          Inc. (
          <a
        ...
        <p>
          ...
          und bedarfsgerechten Gestaltung der Internetseiten von VISION.DEV.
        ...
        <p>
          Sie haben das Recht, von VISIONX.DEV die Einschränkung der
          Verarbeitung zu verlangen, wenn eine der gesetzlichen Voraussetzungen
          gegeben ist.
        </p>
        ...
        <p>
          ...
          Verarbeitung auf der Einwilligung gemäß Art. 6 Abs. 1 lit. a DS-GVO
          oder Art. 9 Abs. 2 lit. a DS-GVO oder auf einem Vertrag gemäß Art. 6
          Abs. 1 lit. b DS-GVO beruht und die Verarbeitung mithilfe
        ...
        <p>
          ...
          (Datenverarbeitung im öffentlichen Interesse) oder f
          (Datenverarbeitung auf Grundlage einer Interessenabwägung) DS-GVO
        ...
        <p>
          Legen Sie Widerspruch ein, wird VISIONX.DEV Ihre personenbezogenen
          Daten nicht mehr verarbeiten, es sei denn, VISIONX.DEV kann zwingende
        ...
        <p>
          ...
          personenbezogener Daten, die bei VISIONX.DEV zu wissenschaftlichen
          oder historischen Forschungszwecken oder zu statistischen Zwecken
          gemäß Art. 89 Abs. 1 DS-GVO erfolgen, Widerspruch einzulegen, es sei
        ...
        <p>
          ...
          Aufsichtsbehörde über die Verarbeitung personenbezogener Daten im
          Rahmen der Nutzung von VISIONX.DEV zu beschweren.
        </p>
        <h2>
        ...
        <p>
          ...
          erforderlich ist oder sofern dies durch den Rechtsvorschriften, welche
          VISIONX.DEV unterliegt, vorgesehen wurde.
        </p>
        <p>
